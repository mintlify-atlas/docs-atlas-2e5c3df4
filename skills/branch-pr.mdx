...
description: "The branch-pr skill enforces issue-first PR creation — every PR must link an approved GitHub issue, follow strict branch naming, and pass automated checks before merge."
---
