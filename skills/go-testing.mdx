...
description: "The go-testing skill provides table-driven tests, Bubbletea model testing, teatest integration, and golden file patterns for Go and TUI projects."
---
