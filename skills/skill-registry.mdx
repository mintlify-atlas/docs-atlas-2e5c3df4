...
description: "The skill-registry skill scans all available skills and project conventions, generates compact rules, and writes .atl/skill-registry.md for the orchestrator to read at session start."
---
...
<Note>
  The `.atl/` directory is added to `.gitignore` automatically if it exists. The skill registry is a generated build artifact — it should not be committed to version control.
</Note>
