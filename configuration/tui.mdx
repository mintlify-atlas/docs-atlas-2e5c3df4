...
sidebarTitle: "TUI"
description: "Configure the OpenCode terminal UI with tui.json — enable the subagent status line plugin and customize how delegations and background agents are displayed."
---
