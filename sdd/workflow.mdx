...
description: "Every SDD phase explained — what each sub-agent reads, writes, and produces, with engram topic keys, TDD rules, and the full artifact dependency graph."
---
