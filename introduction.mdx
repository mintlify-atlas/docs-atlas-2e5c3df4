...
description: "OpenCode Config Agent adds a Tony Stark mentor, SDD pipeline, Engram memory, and context-aware skills to OpenCode for professional AI-assisted development."
---
