...
description: "Three MCP servers in OpenCode Config Agent: context7 for live library docs, Engram for persistent memory, and Chrome DevTools for browser integration."
---
