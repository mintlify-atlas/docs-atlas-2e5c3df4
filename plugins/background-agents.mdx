...
description: "Async sub-agent delegation for OpenCode: fire parallel tasks, get notified on completion, and read disk-persisted results by ID. Survives compaction."
---
