...
description: "Plugin bridging OpenCode to engram's SQLite server: captures prompts, injects memory instructions, and persists session summaries that survive compaction."
---
